...
(function (h) {
    ...
    h.fn.number = function (d, a, c, l) {
        ...
        var i = "\\u" + ("0000" +
            c.charCodeAt(0).toString(16)).slice(-4), n = RegExp("[^" + i + "0-9]", "g"), o = RegExp(i, "g");
        if (d === true)return this.is("input:text") ? this.on({"keydown.format": function (b) {
            var f = h(this), e = f.data("numFormat"), g = b.keyCode ? b.keyCode : b.which, m = "", j = s.apply(this, ["start"]), p = s.apply(this, ["end"]), k = "";
            k = false;
            ...
            var f = h(this), e = f.data("numFormat");
            ...
            var f = h(this), e = b.originalEvent, g = null;
            if (window.clipboardData && window.clipboardData.getData)g = window.clipboardData.getData("Text"); else if (e.clipboardData && e.clipboardData.getData)g = e.clipboardData.getData("text/plain");
            f.val(g);
            b.preventDefault();
            return false
        }}).each(function () {
            var b = h(this).data("numFormat",
                {c: -(a + 1), decimals: a, thousands_sep: l, dec_point: c, regex_dec_num: n, regex_dec: o, init: false});
            this.value !== "" && b.val(b.val())
        }) : this.each(function () {
            var b = h(this), f = +b.text().replace(n, "").replace(o, ".");
    ...
    h.valHooks.text.set = function (d, a) {
        ...
        if (c)return d.value = h.number(a, c.decimals, c.dec_point, c.thousands_sep); else if (h.isFunction(u))return u(d, a)
    };
